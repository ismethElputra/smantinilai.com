...
<div class="main_section_agile" id="home">
    ...
    <a class="navbar-brand" href="../index.php">
        <img src="images/iconsmanti.jpeg" alt="Logo SMANTI" style="height: 50px;">
    </a>
</h1>
			</div>
					...
					<ul class="nav navbar-nav">
						...
						<li> <a class='effect-3 scroll' data-toggle='dropdown'>Jurusan<span class='caret'></span> </a>
							<ul class='dropdown-menu'>
								<li><a href='Bahasa.php' >BAHASA/IBB</a></li>
								<li><a href='Ips.php' >IPS/IIS</a></li>
								<li><a href='Ipa.php' >IPA/MIA</a></li>
							</ul>
						</li>
...
<table class="table text-left">	
	...
	<td> Jurusan : </td>
        <td> <select name="Jurusan">
    			<option value="IBB" selected> IBB </option>
    ...
    <tr>
        ...
        <td><select name="Kelas">
		    <option value="11 IBB" selected> 11 IBB  </option>
			<option value="11 IIS 1"> 11 IIS 1 </option>
			<option value="11 IIS 2"> 11 IIS 2 </option>
			<option value="11 MIA 1"> 11 MIA 2 </option>
			<option value="11 MIA 2"> 11 MIA 2 </option>
			</select>
      	</td>
 	</tr>
    </table>
